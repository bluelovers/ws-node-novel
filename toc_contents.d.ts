...
export declare function processTocContents(basePath: string, outputFile?: string, fnHeader?: typeof makeHeader | typeof makeHeaderAsync): Promise<string>;
export declare function makeHeaderAsync(basePath: string): Promise<string[]>;
