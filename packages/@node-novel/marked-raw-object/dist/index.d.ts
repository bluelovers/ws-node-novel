...
export declare class RawObject<RV extends unknown, RD extends IRawObjectData> {
	...
	getRawData(): RD;
	getRawValue(): RV;
	static isRawObject: typeof isRawObject;
	/**
	 * will remove hidden data and get source data
	 *
	 * @param {RawObject} data
	 */
	static removeRawData: typeof removeRawData;
}
export declare function isRawObject<T extends RawObject<any, any>>(v: any | T): v is Extract<T, RawObject<any, any>>;
export declare function isRawObject<T extends RawObject<unknown, IRawObjectData>>(v: any): v is T;
/**
 * will remove hidden data and get source data
 *
 * @param {RawObject} data
 */
export declare function removeRawData<T>(data: RawObject<T, any>): T;
export declare function removeRawData<T>(data: T): T;

export {
	RawObject as default,
};
